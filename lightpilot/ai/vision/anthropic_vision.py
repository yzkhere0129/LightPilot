...
class AnthropicVision(VisionModel):
    ...
    def analyze(
        ...
        if num_examples > 0:
            for before_path, after_path, caption in examples:
                ...
                content.append({
                    "type": "image",
                    "source": {"type": "base64", "media_type": "image/jpeg", "data": b_b64},
                })
                a_b64 = self._encode_image(after_path)
                content.append({
                    "type": "image",
                    "source": {"type": "base64", "media_type": "image/jpeg", "data": a_b64},
                })
        ...
        content.append({
            "type": "image",
            "source": {"type": "base64", "media_type": "image/jpeg", "data": cur_b64},
        })
