"""Tone Curve parametric sliders panel."""
...
class ToneCurvePanel(QWidget):
    ...
    PARAMS = [
        ("ParametricHighlights", "Highlights", -100, 100, 0, 1, 0),
        ("ParametricLights",     "Lights",     -100, 100, 0, 1, 0),
        ("ParametricDarks",      "Darks",      -100, 100, 0, 1, 0),
        ("ParametricShadows",    "Shadows",    -100, 100, 0, 1, 0),
    ]
